SELECT 1; 
-- Version 7 -> Converting SQL Table Loops to While Loop instead of Selecting Each Row Individually. 
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID,SECTION,tblRow,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COMMENT) -- Setup the HEADER_ROW to separate sections in the TmpTable 
        SELECT {CaseID}, @TBLSECTION, 1, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), '','','','',(SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10402,0))
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox','10402',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        if (@cnt < 10)
            BEGIN
                Insert Into TblTAC_BaseCalc (TruCode, BaseCalcDate, WorksheetID, CaseID, SECTION, tblRow, Amount, Description, Periods, PmtsPerMonth, EffectiveDate)
                SELECT 'TAC', GetDate(), 186, {CaseID}, 2, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'90'+CAST(@cnt as VARCHAR),0)), (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'50'+CAST(@cnt as VARCHAR),0)), 0, 0, '1/1/1900'
        ...
        ELSE
            BEGIN
                Insert Into TblTAC_BaseCalc (TruCode, BaseCalcDate, WorksheetID, CaseID, SECTION, tblRow, Amount, Description, Periods, PmtsPerMonth, EffectiveDate)
                SELECT 'TAC', GetDate(), 186, {CaseID}, 2, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'9'+CAST(@cnt as VARCHAR),0)), (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'5'+CAST(@cnt as VARCHAR),0)), 0, 0, '1/1/1900'
...
WHILE @cnt < @cnt_total
    BEGIN
        if (@cnt < 10)
            BEGIN
                Insert Into TblTAC_BaseCalc (TruCode, BaseCalcDate, WorksheetID, CaseID, SECTION, tblRow, Amount, Description, Periods, PmtsPerMonth, EffectiveDate)
                SELECT 'TAC', GetDate(), 186, {CaseID}, 3, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'70'+CAST(@cnt as VARCHAR),0)), (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'80'+CAST(@cnt as VARCHAR),0)), 0, 0, '1/1/1900'
        ...
        ELSE
            BEGIN
                Insert Into TblTAC_BaseCalc (TruCode, BaseCalcDate, WorksheetID, CaseID, SECTION, tblRow, Amount, Description, Periods, PmtsPerMonth, EffectiveDate)
                SELECT 'TAC', GetDate(), 186, {CaseID}, 3, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'7'+CAST(@cnt as VARCHAR),0)), (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'8'+CAST(@cnt as VARCHAR),0)), 0, 0, '1/1/1900'
...
WHILE @cnt < @cnt_total
    BEGIN
        if (@cnt < 10)
            BEGIN
                INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
                SELECT {CaseID}, @TBLSECTION,@cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'90'+CAST(@cnt as VARCHAR),0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'50'+CAST(@cnt as VARCHAR),0),'','','','','',''
 ...
 SET @cnt = @cnt + 1;
        ...
        ELSE
            BEGIN
                INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
                SELECT {CaseID}, @TBLSECTION,@cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'9'+CAST(@cnt as VARCHAR),0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'5'+CAST(@cnt as VARCHAR),0),'','','','','',''
                WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'9'+CAST(@cnt as VARCHAR),0) <> '' 
                SET @cnt = @cnt + 1;
            END
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        if (@cnt < 10)
            BEGIN
                INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
                SELECT {CaseID}, @TBLSECTION,@cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'70'+CAST(@cnt as VARCHAR),0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'80'+CAST(@cnt as VARCHAR),0),'','','','','',''
                WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'70'+CAST(@cnt as VARCHAR),0) <> '' 
                 SET @cnt = @cnt + 1;
            END
        ELSE
            BEGIN
                INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
                SELECT {CaseID}, @TBLSECTION,@cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'7'+CAST(@cnt as VARCHAR),0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'8'+CAST(@cnt as VARCHAR),0),'','','','','',''
                WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +'7'+CAST(@cnt as VARCHAR),0) <> '' 
                SET @cnt = @cnt + 1;
            END
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10902,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
-- Section 52
SET @cnt = 0;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10903,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10904,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10905,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10906,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10907,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10908,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'CheckBox','580',0) <> '' 
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10910,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10911,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10912,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10913,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> ''  or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10914,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
...
WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox','6501',0) <> ''
...
WHILE @cnt < @cnt_total
    BEGIN
        INSERT INTO tblTAC_PlanNarrative (CaseID, SECTION, tblRow, COL1, COL2, COL3, COL4, COL5, COL6, COL7, Comment)
        SELECT {CaseID}, @TBLSECTION, @cnt, (SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'1',0)),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0), dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'4',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'5',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'6',0),dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) + '7',0),ISNULL((SELECT dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox',10916,0)), '0')
        WHERE dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) +CAST(@cnt as VARCHAR) +'1',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'2',0) <> '' or dbo.udfGetWorksheetData({CaseID},@WORKSHEETID,'TextBox', CAST(@TBLSECTION as VARCHAR) + CAST(@cnt as VARCHAR) +'3',0) <> ''
        SET @cnt = @cnt + 1;
    END;
